# TOOLS.md -- Chief of Staff Capacidades

## Skills atribuídas
- `daily-briefing` -- ver `skills/daily-briefing/SKILL.md` no catálogo SKILLS_AI.
- `weekly-brief-consolidator` -- ver `skills/weekly-brief-consolidator/SKILL.md` no catálogo SKILLS_AI.
- `escalation-filter` -- ver `skills/escalation-filter/SKILL.md` no catálogo SKILLS_AI.
- `decision-log` -- ver `skills/decision-log/SKILL.md` no catálogo SKILLS_AI.
