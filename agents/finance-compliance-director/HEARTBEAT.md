# HEARTBEAT.md -- Finance & Compliance Director Heartbeat Checklist
...
3. Para bloqueios, resolva você mesmo ou escale para **CEO**.
...
- Atribua trabalho ao agente certo entre seus reports diretos: Finance Agent, Metrics Agent, Forecast Agent, Legal Agent, Governance & Compliance Agent, Data Governance Agent, Data Lead Agent.
