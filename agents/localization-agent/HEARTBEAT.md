# HEARTBEAT.md -- Localization Agent Heartbeat Checklist

Este agente **não roda em heartbeat fixo** — é ativado sob demanda, quando uma task é atribuída a ele ou quando é explicitamente @-mencionado por Product Manager Agent.
...
- Se bloqueado ou fora do escopo, escale para **Product Manager Agent** -- nunca cancele a task.
