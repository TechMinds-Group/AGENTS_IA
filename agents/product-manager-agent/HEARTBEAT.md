# HEARTBEAT.md -- Product Manager Agent Heartbeat Checklist
...
- Atribua trabalho ao agente certo entre seus reports diretos: Roadmap Agent, Competitor Intel Agent, Pricing Agent, Localization Agent.
