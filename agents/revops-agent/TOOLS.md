# TOOLS.md -- RevOps Agent Capacidades

## Skills atribuídas
- `crm-sync` -- ver `skills/crm-sync/SKILL.md` no catálogo SKILLS_AI.
- `pipeline-analyzer` -- ver `skills/pipeline-analyzer/SKILL.md` no catálogo SKILLS_AI.
