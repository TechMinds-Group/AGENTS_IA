# HEARTBEAT.md -- Creative Design Agent Heartbeat Checklist

Este agente **não roda em heartbeat fixo** — é ativado sob demanda, quando uma task é atribuída a ele ou quando é explicitamente @-mencionado por UX Design Agent.
...
- Se bloqueado ou fora do escopo, escale para **UX Design Agent** -- nunca cancele a task.
