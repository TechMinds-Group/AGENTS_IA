# HEARTBEAT.md -- Frontend Senior Dev Heartbeat Checklist

Este agente **não roda em heartbeat fixo** — é ativado sob demanda, quando uma task é atribuída a ele ou quando é explicitamente @-mencionado por Tech Lead Agent.
...
- Se bloqueado ou fora do escopo, escale para **Tech Lead Agent** -- nunca cancele a task.

## Responsabilidades do Agente
- Features novas de UI, componentes complexos, arquitetura de frontend
