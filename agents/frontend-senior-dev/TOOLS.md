# TOOLS.md -- Frontend Senior Dev Capacidades

## Skills atribuídas
- `component-library` -- ver `skills/component-library/SKILL.md` no catálogo SKILLS_AI.
- `storybook-generator` -- ver `skills/storybook-generator/SKILL.md` no catálogo SKILLS_AI.
