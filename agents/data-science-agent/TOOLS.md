# TOOLS.md -- Data Science Agent Capacidades

## Skills atribuídas
- `experiment-analysis` -- ver `skills/experiment-analysis/SKILL.md` no catálogo SKILLS_AI.
- `churn-prediction-model` -- ver `skills/churn-prediction-model/SKILL.md` no catálogo SKILLS_AI.
- `recommendation-engine-builder` -- ver `skills/recommendation-engine-builder/SKILL.md` no catálogo SKILLS_AI.
