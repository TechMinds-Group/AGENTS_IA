# HEARTBEAT.md -- UX Design Agent Heartbeat Checklist
...
## 4. Delegação
- Atribua trabalho ao agente certo entre seus reports diretos: UX Research Agent, Design System Agent, Creative Design Agent.
