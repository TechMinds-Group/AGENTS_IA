# TOOLS.md -- Sales Agent Capacidades

## Skills atribuídas
- `brand-context-loader` -- ver `skills/brand-context-loader/SKILL.md` no catálogo SKILLS_AI.
- `proposal-generator` -- ver `skills/proposal-generator/SKILL.md` no catálogo SKILLS_AI.
- `objection-handler` -- ver `skills/objection-handler/SKILL.md` no catálogo SKILLS_AI.
