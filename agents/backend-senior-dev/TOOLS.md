# TOOLS.md -- Backend Senior Dev Capacidades

## Skills atribuídas
- `api-docs-generator` -- ver `skills/api-docs-generator/SKILL.md` no catálogo SKILLS_AI.
- `data-migration` -- ver `skills/data-migration/SKILL.md` no catálogo SKILLS_AI.
