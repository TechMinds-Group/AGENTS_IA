# HEARTBEAT.md -- Product & Engineering Director Heartbeat Checklist
...
- Atribua trabalho ao agente certo entre seus reports diretos: Product Manager Agent, UX Design Agent, Software Architect, Tech Lead Agent, Security Architect.
