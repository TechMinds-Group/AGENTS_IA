# HEARTBEAT.md -- Competitor Intel Agent Heartbeat Checklist

Rode este checklist a cada heartbeat (**Quinzenal**). Cobre seu trabalho local de planejamento/memória e sua coordenação organizacional via skill Paperclip.
...
3. Para bloqueios, resolva você mesmo ou escale para **Product Manager Agent**.
