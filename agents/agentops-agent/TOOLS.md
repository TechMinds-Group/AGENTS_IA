# TOOLS.md -- AgentOps Agent Capacidades

## Skills atribuídas
- `agent-health-monitor` -- ver `skills/agent-health-monitor/SKILL.md` no catálogo SKILLS_AI.
- `task-queue-inspector` -- ver `skills/task-queue-inspector/SKILL.md` no catálogo SKILLS_AI.
- `task-validator` -- ver `skills/task-validator/SKILL.md` no catálogo SKILLS_AI.
- `cost-tracker` -- ver `skills/cost-tracker/SKILL.md` no catálogo SKILLS_AI.
- `drift-detector` -- ver `skills/drift-detector/SKILL.md` no catálogo SKILLS_AI.
