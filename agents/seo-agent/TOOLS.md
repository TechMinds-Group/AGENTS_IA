# TOOLS.md -- SEO Agent Capacidades

## Skills atribuídas
- `keyword-research` -- ver `skills/keyword-research/SKILL.md` no catálogo SKILLS_AI.
- `on-page-optimizer` -- ver `skills/on-page-optimizer/SKILL.md` no catálogo SKILLS_AI.
- `link-building-scout` -- ver `skills/link-building-scout/SKILL.md` no catálogo SKILLS_AI.
