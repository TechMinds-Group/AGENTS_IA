# HEARTBEAT.md -- Revenue Director Heartbeat Checklist
...
- Atribua trabalho ao agente certo entre seus reports diretos: Growth Agent, Sales Agent, Customer Success Agent.
