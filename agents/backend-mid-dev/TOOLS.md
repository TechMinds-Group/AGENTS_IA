# TOOLS.md -- Backend Mid Dev Capacidades

## Skills atribuídas
- `openapi-validator` -- ver `skills/openapi-validator/SKILL.md` no catálogo SKILLS_AI.
- `refactoring-assistant` -- ver `skills/refactoring-assistant/SKILL.md` no catálogo SKILLS_AI.
