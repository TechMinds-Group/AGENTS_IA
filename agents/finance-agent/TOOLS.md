# TOOLS.md -- Finance Agent Capacidades

## Skills atribuídas
- `unit-economics-calculator` -- ver `skills/unit-economics-calculator/SKILL.md` no catálogo SKILLS_AI.
- `burn-rate-monitor` -- ver `skills/burn-rate-monitor/SKILL.md` no catálogo SKILLS_AI.
- `cost-attribution` -- ver `skills/cost-attribution/SKILL.md` no catálogo SKILLS_AI.
