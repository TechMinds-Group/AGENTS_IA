# HEARTBEAT.md -- Data Lead Agent Heartbeat Checklist

Rode este checklist a cada heartbeat (**Mensal**). Cobre seu trabalho local de planejamento/memória e sua coordenação organizacional via skill Paperclip.
...
- Atribua trabalho ao agente certo entre seus reports diretos: Data Engineer Agent, BI Agent, Data Science Agent.
