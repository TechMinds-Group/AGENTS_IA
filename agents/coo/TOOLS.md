# TOOLS.md -- COO Capacidades

## Skills atribuídas
- `okr-tracking` -- ver `skills/okr-tracking/SKILL.md` no catálogo SKILLS_AI.
- `vendor-audit` -- ver `skills/vendor-audit/SKILL.md` no catálogo SKILLS_AI.
