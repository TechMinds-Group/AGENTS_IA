# TOOLS.md -- Customer Success Agent Capacidades

## Skills atribuídas
- `health-score-calculator` -- ver `skills/health-score-calculator/SKILL.md` no catálogo SKILLS_AI.
- `onboarding-checklist-builder` -- ver `skills/onboarding-checklist-builder/SKILL.md` no catálogo SKILLS_AI.
