# HEARTBEAT.md -- Customer Success Agent Heartbeat Checklist
...
3. Para bloqueios, resolva você mesmo ou escale para **Revenue Director**.
...
- Atribua trabalho ao agente certo entre seus reports diretos: Support Agent, L2 Agent, Churn Prevention Agent, Expansion Agent.
