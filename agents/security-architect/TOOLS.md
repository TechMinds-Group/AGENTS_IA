# TOOLS.md -- Security Architect Capacidades

## Skills atribuídas
- `threat-modeling` -- ver `skills/threat-modeling/SKILL.md` no catálogo SKILLS_AI.
- `incident-postmortem-builder` -- ver `skills/incident-postmortem-builder/SKILL.md` no catálogo SKILLS_AI.
