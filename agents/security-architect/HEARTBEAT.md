# HEARTBEAT.md -- Security Architect Heartbeat Checklist
...
## 4. Delegação
- Atribua trabalho ao agente certo entre seus reports diretos: AppSec Agent, Vulnerability Agent, Compliance Security Agent.
