# TOOLS.md -- Legal Agent Capacidades

## Skills atribuídas
- `contract-template-builder` -- ver `skills/contract-template-builder/SKILL.md` no catálogo SKILLS_AI.
- `terms-of-service-builder` -- ver `skills/terms-of-service-builder/SKILL.md` no catálogo SKILLS_AI.
