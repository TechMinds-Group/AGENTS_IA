# HEARTBEAT.md -- Legal Agent Heartbeat Checklist

Este agente **não roda em heartbeat fixo** — é ativado sob demanda, quando uma task é atribuída a ele ou quando é explicitamente @-mencionado por Finance & Compliance Director.
...
- Se bloqueado ou fora do escopo, escale para **Finance & Compliance Director** -- nunca cancele a task.
