# HEARTBEAT.md -- Data Engineer Agent Heartbeat Checklist

Este agente **não roda em heartbeat fixo** — é ativado sob demanda, quando uma task é atribuída a ele ou quando é explicitamente @-mencionado por Data Lead Agent.
...
- Se bloqueado ou fora do escopo, escale para **Data Lead Agent** -- nunca cancele a task.
