# HEARTBEAT.md -- Process Agent Heartbeat Checklist

Este agente **não roda em heartbeat fixo** — é ativado sob demanda, quando uma task é atribuída a ele ou quando é explicitamente @-mencionado por COO.
...
- Se bloqueado ou fora do escopo, escale para **COO** -- nunca cancele a task.

## Responsabilidades do Agente
- Criação e manutenção de SOPs e playbooks
