# HEARTBEAT.md -- Tech Lead Agent Heartbeat Checklist
...
3. Para bloqueios, resolva você mesmo ou escale para **Product & Engineering Director**.
...
- Atribua trabalho ao agente certo entre seus reports diretos: Frontend Senior Dev, Frontend Mid Dev, Frontend Junior Dev, Backend Senior Dev, Backend Mid Dev, Backend Junior Dev, Integration Agent, QA Agent, DevOps Agent, Database Architect, Tech Writer Agent.
