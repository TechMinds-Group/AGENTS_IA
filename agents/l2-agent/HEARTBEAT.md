# HEARTBEAT.md -- L2 Agent Heartbeat Checklist

Este agente **não roda em heartbeat fixo** — é ativado sob demanda, quando uma task é atribuída a ele ou quando é explicitamente @-mencionado por Customer Success Agent.
...
- Se bloqueado ou fora do escopo, escale para **Customer Success Agent** -- nunca cancele a task.
