# HEARTBEAT.md -- Compliance Security Agent Heartbeat Checklist

Rode este checklist a cada heartbeat (**Trimestral**). Cobre seu trabalho local de planejamento/memória e sua coordenação organizacional via skill Paperclip.
...
3. Para bloqueios, resolva você mesmo ou escale para **Security Architect**.
