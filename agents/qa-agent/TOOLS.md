# TOOLS.md -- QA Agent Capacidades

## Skills atribuídas
- `unit-test-generator` -- ver `skills/unit-test-generator/SKILL.md` no catálogo SKILLS_AI.
- `e2e-test-generator` -- ver `skills/e2e-test-generator/SKILL.md` no catálogo SKILLS_AI.
- `regression-runner` -- ver `skills/regression-runner/SKILL.md` no catálogo SKILLS_AI.
