# TOOLS.md -- Frontend Mid Dev Capacidades

## Skills atribuídas
- `a11y-audit` -- ver `skills/a11y-audit/SKILL.md` no catálogo SKILLS_AI.
- `responsive-audit` -- ver `skills/responsive-audit/SKILL.md` no catálogo SKILLS_AI.
