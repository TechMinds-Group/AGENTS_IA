# HEARTBEAT.md -- Tech Writer Agent Heartbeat Checklist

Rode este checklist a cada heartbeat (**Por release**). Cobre seu trabalho local de planejamento/memória e sua coordenação organizacional via skill Paperclip.
...
3. Para bloqueios, resolva você mesmo ou escale para **Tech Lead Agent**.
