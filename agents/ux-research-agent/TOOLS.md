# TOOLS.md -- UX Research Agent Capacidades

## Skills atribuídas
- `user-journey-mapping` -- ver `skills/user-journey-mapping/SKILL.md` no catálogo SKILLS_AI.
- `ux-audit` -- ver `skills/ux-audit/SKILL.md` no catálogo SKILLS_AI.
- `heuristic-review` -- ver `skills/heuristic-review/SKILL.md` no catálogo SKILLS_AI.
